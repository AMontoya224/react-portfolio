    ...
    <div className="App">
      ...
      <BrowserRouter>
        ...
        <Switch>
          ...
          <Route exact path="/projects/programming" render={ routeProps => <WorksD onSelectLeft={onSelectLeft} scrollSelect={scrollSelect} selectLeft={selectLeft} testRef1={testRef1} testRef2={testRef2} testRef3={testRef3} testRef4={testRef4} selectLan={selectLan} {...routeProps} />}/>
